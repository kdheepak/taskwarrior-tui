---
title: Installation
description: Install taskwarrior-tui manually, from source, or with common package managers.
---
...
Or use your favorite [AUR helper](https://wiki.archlinux.org/index.php/AUR_helpers) to install the [git](https://aur.archlinux.org/packages/taskwarrior-tui-git/) package maintained by [@loki7990](https://github.com/loki7990). For example:

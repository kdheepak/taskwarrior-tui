...
impl KeyConfig {
  ...
  pub fn check(&self) -> Result<()> {
    let elements = vec![
      ...
      ("priority_h", &self.priority_h),
      ("priority_m", &self.priority_m),
      ("priority_l", &self.priority_l),
      ("priority_n", &self.priority_n),
      ("priority_up", &self.priority_up),
      ("priority_down", &self.priority_down),
